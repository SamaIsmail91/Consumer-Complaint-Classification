...
| :--- | :---: | :---: | :---: | :---: | :---: |
| **SimpleRNN** | 62.4% | 0.61 | 0.62 | 0.61 | **Fastest** (~5ms) |
| **LSTM** | 81.2% | 0.81 | 0.81 | 0.81 | Fast (~12ms) |
| **GRU** | 82.5% | 0.82 | 0.82 | 0.82 | Fast (~10ms) |
| **DistilBERT (Transformer)**| **89.7%** | **0.90** | **0.89** | **0.89** | Moderate (~35ms) |
